...
public:
    ...
    void bo_log_init(double back1_velocity, double back1_duration, double forw_velocity, double forw_duration, double back2_velocity, double back2_duration, int wait_duration, double human_approach_vel, double robot_vel,std::string frame_id);
    void st_log_init(int wait_duration, double human_approach_vel, double robot_vel, std::string frame_id);

    void finalize_log(bool back_off);
